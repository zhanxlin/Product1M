...
class BertEncoder(nn.Module):
    ...
    def forward(
        ...
        return all_encoder_layers_t, all_encoder_layers_v,\
               CLR_loss, (all_attention_mask_t, all_attnetion_mask_v, all_attention_mask_c)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        extended_co_attention_mask = extended_co_attention_mask.to(dtype=torch.float32)
        ...
        # co encoder
        sequence_output_t, sequence_output_v = self._get_cross_output(
...
class BertForMultiModalPreTraining(BertPreTrainedModel):
    ...
    def forward(
        ...
        prediction_scores_t, prediction_scores_v, = self.cls(
            sequence_output_t, sequence_output_v
        )
